...
const LinkModal = ({ album, isOpen, onClose, snake}) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-md flex justify-center items-center z-50" onClick={handleBackdropClick}>
            <div className="phone-modal bg-white p-8 md:p-12 shadow-lg max-w-md mx-auto relative" onClick={(e) => e.stopPropagation()}>
                <button
                    onClick={onClose}
                ...
                <div className="space-y-4">
                    {album.links.map((link, index) => (
                        <div key={index} className="phone-links flex justify-between border-2 items-center bg-gray-100 transition-colors p-2">
                            ...
                            <a
                                ...
                                className="phone-play py-2 px-4 bg-gray-400 text-white hover:bg-gray-700 transition-colors"
                            >
                                Play
                            </a>
                        </div>
